...
class TutorialBuildingCoresForm(npyscreen.ActionFormWithMenus):
    ...
    def create(self):
        ...
        self.add(npyscreen.TitleText, name="Building Cores", editable=False)
    ...
    def on_ok(self):
        ...
        self.switch("TUTORIALSTARTINGCORES")
