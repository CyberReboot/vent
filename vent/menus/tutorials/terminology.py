...
class TutorialTerminologyForm(npyscreen.ActionFormWithMenus):
    ...
    def create(self):
        ...
        self.add(npyscreen.TitleText, name="Vent Terminology", editable=False)
    ...
    def on_ok(self):
        ...
        self.switch("TUTORIALGETTINGSETUP")
