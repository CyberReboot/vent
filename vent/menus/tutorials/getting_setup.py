...
class TutorialGettingSetupForm(npyscreen.ActionFormWithMenus):
    ...
    def create(self):
        ...
        self.add(npyscreen.TitleText, name="Getting Setup", editable=False)
    ...
    def on_ok(self):
        ...
        self.switch("TUTORIALBUILDINGCORES")
