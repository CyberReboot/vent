...
class TutorialAddingFilesForm(npyscreen.ActionFormWithMenus):
    ...
    def create(self):
        ...
        self.add(npyscreen.TitleText, name="Adding Files", editable=False)
    ...
    def on_ok(self):
        ...
        self.switch("TUTORIALSETTINGUPSERVICES")
