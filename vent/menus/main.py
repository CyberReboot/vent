...
class MainForm(npyscreen.FormBaseNewWithMenus):
    ...
    def perform_action(self, action):
        ...
        if action == 'add':
            ...
            form = BuildToolsForm
            forms = ['BUILDTOOLS']
            form_args['name'] = "Build tools"
        elif action == 'start':
            form = StartToolsForm
            forms = ['STARTTOOLS']
            form_args['name'] = "Start tools"
        elif action == 'stop':
            form = StopToolsForm
            forms = ['STOPTOOLS']
            form_args['name'] = "Stop tools"
        elif action == 'clean':
            form = CleanToolsForm
            forms = ['CLEANTOOLS']
            form_args['name'] = "Clean tools"
            ...
            forms = ['UPDATETOOLS']
            form_args['name'] = "Update tools"
        elif action == "remove":
            form = RemoveToolsForm
            forms = ['REMOVETOOLS']
            form_args['name'] = "Remove tools"
        elif action == 'logs':
            form = LogsForm
            forms = ['LOGS']
