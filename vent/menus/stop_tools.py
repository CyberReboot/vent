...
class StopToolsForm(npyscreen.ActionForm):
    ...
    def while_waiting(self):
        ...
        if not self.triggered:
            i = 4
            api_action = Action()
            inventory = api_action.inventory(choices=['repos', 'tools', 'running', 'core'])
    ...
    def on_ok(self):
        """
        Take the tool selections and stop them
        """
