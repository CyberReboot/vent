...
def test_url():
    """ Tests get_urls """
    get_urls.url(PathDirs(), "elasticsearch", "head")
    get_urls.url(PathDirs(), "elasticsearch", "marvel")
    get_urls.url(PathDirs(), "aaa-rabbitmq", "")
    get_urls.url(PathDirs(), "rq-dashboard","")
    get_urls.url(PathDirs(), "aaa-syslog", "")
